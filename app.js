...
// ---------- Register student (hardcoded name & email) ----------
  ...
  "",
  "Time:",
  `✔ 25 questions, ${config.durationMinutes} minutes, auto-closes at scheduled time.`,
  "",
  "Evaluation:",
  "✔ +1 for correct, -1 for wrong answer.",
  "✔ Tie-breaker: earlier submission, then additional criteria.",
  "",
  "Fair Participation:",
